...
gen1 = GenMatch(Tr= data12$treat, X=X, BalanceMatrix = X, pop.size=100, replace=FALSE)
...
R2_replace= cor(data12$log_mean_time_MA_PA[mgen1$index.control],data12$log_mean_time_MA_PA[mgen1$index.treated])^2
